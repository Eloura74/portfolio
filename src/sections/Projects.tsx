...
const Projects: React.FC = () => {
  ...
  return (
    <section id="projets" className="py-20 bg-gradient-to-b from-slate-800 to-slate-900">
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <p className="text-gray-300 max-w-2xl mx-auto">
            ...
            en développement web et ma capacité à résoudre des problèmes complexes.
          </p>
        </motion.div>
              ...
              <div className="bg-secondary-800/80 backdrop-blur-sm rounded-xl overflow-hidden border border-white/5 shadow-xl h-full flex flex-col group hover:border-primary-500/20 transition-all duration-300 hover:shadow-primary-500/5 hover:shadow-2xl hover:-translate-y-1">
                ...
                <div className="p-6 flex-1 flex flex-col relative">
                  ...
                  <div className="mb-4 relative">
                    ...
                    <p className="text-gray-300 text-sm transform transition-all duration-300 group-hover:text-gray-200">{projet.description}</p>
                  </div>

                  {/* Technologies avec effet de survol */}
                  <div className="mb-4">
                    <h4 className="text-xs font-semibold text-primary-400 mb-2 transform transition-all duration-300 group-hover:text-primary-300">Technologies utilisées</h4>
                  ...
                  <div className="mb-4 flex-1">
                    <h4 className="text-xs font-semibold text-primary-400 mb-2 transform transition-all duration-300 group-hover:text-primary-300">Points clés</h4>
                    <ul className="text-gray-300 text-xs space-y-1">
                      {projet.problemes.map((probleme, i) => (
                        ...
                        >
                          <span className="text-primary-400 transition-colors duration-300 group-hover/item:text-primary-300">•</span>
                          <span className="transition-colors duration-300 group-hover/item:text-gray-200">{probleme}</span>
                        </motion.li>
                      ))}
                    </ul>
                  </div>
